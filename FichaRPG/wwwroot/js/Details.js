...
criar.onclick = function () {
    ...
    var linkAPI1 = basePath + 'Personagem/CriaDadoPersonalizado?id=' + id.value + "&nome=" + nomeDado.value + "&dado=" + x + "&dano=" + dano.checked;
    $.ajax({
        type: "POST",
        url: linkAPI1,
        dataType: "json",
...
Vida.onchange = function () {
    ...
    var linkAPI1 = basePath + 'Personagem/AtualizaVida?id=' + id.value + "&vida=" + Vida.value;
    $.ajax({
        type: "POST",
        url: linkAPI1,
        dataType: "json",
...
Sanidade.onchange = function () {
    ...
    var linkAPI2 = basePath + 'Personagem/AtualizaSanidade?id=' + id.value + "&sanidade=" + Sanidade.value;
    $.ajax({
        type: "POST",
        url: linkAPI2,
        dataType: "json",
...
Pe.onchange = function () {
    ...
    var linkAPI3 = basePath + 'Personagem/AtualizaPe?id=' + id.value + "&pe=" + Pe.value;
    $.ajax({
        type: "POST",
        url: linkAPI3,
        dataType: "json",
...
function AdicionaMaisUm(caracteristica) {
    var linkAPI1 = basePath + 'Personagem/AdicionaUm?id=' + id.value + "&caracteristica=" + caracteristica.toString();
    $.ajax({
        type: "POST",
        url: linkAPI1,
        dataType: "json",
...
function AdicionaMaisCinco(caracteristica) {
    var linkAPI1 = basePath + 'Personagem/AdicionaCinco?id=' + id.value + "&caracteristica=" + caracteristica.toString();
    $.ajax({
        type: "POST",
        url: linkAPI1,
        dataType: "json",
...
function DiminuiMenosUm(caracteristica) {
    var linkAPI1 = basePath + 'Personagem/DiminuiUm?id=' + id.value + "&caracteristica=" + caracteristica.toString();
    $.ajax({
        type: "POST",
        url: linkAPI1,
        dataType: "json",
...
function DiminuiMenosCinco(caracteristica) {
    var linkAPI1 = basePath + 'Personagem/DiminuiCinco?id=' + id.value + "&caracteristica=" + caracteristica.toString();
    $.ajax({
        type: "POST",
        url: linkAPI1,
        dataType: "json",
